import { ALIGN_OPTIONS, COLORS, CTA_ALIGN_OPTIONS, CTA_STYLE_OPTIONS, FONTS, FONT_WEIGHTS, FRAME_OPTIONS, HEADLINE_POS_OPTIONS, MARK_MODE_OPTIONS, SERIF_FONTS, T2_FONTS, TEXTURE_OPTIONS } from '@/config/constants'
  ...
  template15: [
    {
      title: 'Content',
      fields: [
        area('post.t15.headline', 'Headline', { hint: 'Line breaks stay. Use [brackets] for accent words.' }),
        text('post.t15.kickerText', 'Kicker', { togglePath: 'post.t15.showKicker' }),
        area('post.t15.dek', 'Body', { rows: 2, togglePath: 'post.t15.showDek' }),
        text('post.t15.ctaText', 'CTA', { togglePath: 'post.t15.showCta', hint: 'Website, phone, or any label' }),
      ],
    },
    {
      title: 'Media',
      fields: [
        image('post.t15.bgImage', 'Background', [
          ...imagePos('post.t15.'),
          slider('post.t15.bgOpacity', 'Opacity', 0, 1, { step: 0.05, unit: '%' }),
        ]),
        image('post.t15.subjectUrl', 'Circle / subject', [
          toggle('post.t15.showSubject', 'Show subject'),
          toggle('post.t15.grayscale', 'Black & white'),
          select('post.t15.frameShape', 'Frame', FRAME_OPTIONS),
          slider('post.t15.subjectSize', 'Size', 240, 980, { unit: 'px' }),
          slider('post.t15.subjectPosX', 'Position X', 0, 100, { unit: '%' }),
          slider('post.t15.subjectPosY', 'Position Y', 0, 100, { unit: '%' }),
          slider('post.t15.subjectImageScale', 'Zoom', 100, 250, { unit: '%' }),
          slider('post.t15.subjectImagePosX', 'Crop X', 0, 100, { unit: '%' }),
          slider('post.t15.subjectImagePosY', 'Crop Y', 0, 100, { unit: '%' }),
          slider('post.t15.frameRadius', 'Corner radius', 8, 80, { unit: 'px' }),
          slider('post.t15.frameBorder', 'Border', 0, 16, { unit: 'px' }),
          color('post.t15.frameBorderColor', 'Border color'),
          toggle('post.t15.showSubjectGlow', 'Glow'),
          color('post.t15.subjectGlowColor', 'Glow color'),
          slider('post.t15.subjectGlowOpacity', 'Glow opacity', 0, 1, { step: 0.05, unit: '%' }),
          slider('post.t15.subjectGlowSize', 'Glow size', 0.4, 2.4, { step: 0.05 }),
        ]),
      ],
    },
    {
      title: 'Headline',
      fields: [
        select('post.t15.headlinePos', 'Position', HEADLINE_POS_OPTIONS),
        font('post.t15.fontFamily', 'post.t15.customFontFamily', T2_FONTS),
        slider('post.t15.fontSize', 'Size', 32, 120, { unit: 'px' }),
        select('post.t15.fontWeight', 'Weight', FONT_WEIGHTS),
        toggle('post.t15.uppercase', 'Uppercase'),
        color('post.t15.headlineColor', 'Text color'),
        color('post.t15.highlightColor', 'Highlight [ ]'),
        select('post.t15.textAlign', 'Align', ALIGN_OPTIONS),
        slider('post.t15.lineHeight', 'Line height', 0.9, 1.4, { step: 0.01 }),
        slider('post.t15.letterSpacing', 'Letter spacing', -0.06, 0.08, { step: 0.005, unit: 'em' }),
        slider('post.t15.copyOffsetX', 'Offset X', -80, 80, { unit: 'px' }),
        slider('post.t15.copyOffsetY', 'Offset Y', -80, 80, { unit: 'px' }),
        slider('post.t15.copyBottomGap', 'Bottom clearance', 16, 80, { unit: 'px' }),
        slider('post.t15.paddingH', 'Padding X', 24, 120, { unit: 'px' }),
        slider('post.t15.paddingV', 'Padding Y', 32, 160, { unit: 'px' }),
      ],
    },
    {
      title: 'Kicker',
      fields: [
        slider('post.t15.kickerSize', 'Size', 12, 36, { unit: 'px' }),
        color('post.t15.kickerColor', 'Color'),
        slider('post.t15.kickerLetterSpacing', 'Spacing', 0, 0.4, { step: 0.01, unit: 'em' }),
      ],
    },
    {
      title: 'Body',
      fields: [
        font('post.t15.dekFontFamily', 'post.t15.customDekFontFamily', T2_FONTS),
        slider('post.t15.dekSize', 'Size', 14, 42, { unit: 'px' }),
        select('post.t15.dekWeight', 'Weight', FONT_WEIGHTS),
        color('post.t15.dekColor', 'Color'),
        slider('post.t15.dekLineHeight', 'Line height', 1, 1.6, { step: 0.01 }),
        slider('post.t15.dekLetterSpacing', 'Spacing', -0.06, 0.08, { step: 0.005, unit: 'em' }),
      ],
    },
    {
      title: 'CTA',
      fields: [
        select('post.t15.ctaStyle', 'Style', CTA_STYLE_OPTIONS),
        select('post.t15.ctaAlign', 'Align', CTA_ALIGN_OPTIONS),
        toggle('post.t15.ctaFullWidth', 'Full text width'),
        slider('post.t15.ctaSize', 'Size', 14, 36, { unit: 'px' }),
        select('post.t15.ctaWeight', 'Weight', FONT_WEIGHTS),
        color('post.t15.ctaBg', 'Fill / accent'),
        color('post.t15.ctaColor', 'Text'),
        slider('post.t15.ctaRadius', 'Corners', 0, 40, { unit: 'px' }),
        slider('post.t15.ctaPadH', 'Padding X', 12, 48, { unit: 'px' }),
        slider('post.t15.ctaPadV', 'Padding Y', 8, 28, { unit: 'px' }),
        slider('post.t15.ctaLetterSpacing', 'Spacing', -0.04, 0.08, { step: 0.005, unit: 'em' }),
        slider('post.t15.ctaBorder', 'Border', 0, 6, { unit: 'px' }),
        color('post.t15.ctaBorderColor', 'Border color'),
        slider('post.t15.ctaMarginTop', 'Top spacing', 0, 48, { unit: 'px' }),
        slider('post.t15.ctaOffsetX', 'Offset X', -80, 80, { unit: 'px' }),
        slider('post.t15.ctaOffsetY', 'Offset Y', -40, 40, { unit: 'px' }),
      ],
    },
    {
      title: 'Brand',
      fields: [
        toggle('post.t15.showBrandRow', 'Show top brand row'),
        text('post.t15.brandText', 'Brand name', { togglePath: 'post.t15.showBrand' }),
        select('post.t15.markMode', 'Mark', MARK_MODE_OPTIONS),
        image('post.t15.markImageUrl', 'Custom icon', [
          slider('post.t15.markSize', 'Icon size', 18, 64, { unit: 'px' }),
          color('post.t15.accentColor', 'Dot color'),
        ]),
        font('post.t15.brandFontFamily', 'post.t15.customBrandFontFamily', T2_FONTS),
        slider('post.t15.brandSize', 'Size', 16, 48, { unit: 'px' }),
        select('post.t15.brandWeight', 'Weight', FONT_WEIGHTS),
        slider('post.t15.brandLetterSpacing', 'Spacing', -0.06, 0.2, { step: 0.005, unit: 'em' }),
        color('post.t15.brandColor', 'Color'),
        slider('post.t15.brandPosX', 'Offset X', -60, 60, { unit: 'px' }),
        slider('post.t15.brandPosY', 'Offset Y', -60, 60, { unit: 'px' }),
      ],
    },
    {
      title: 'Footer',
      fields: [
        text('post.t15.footerLeft', 'Footer left', { togglePath: 'post.t15.showFooter' }),
        text('post.t15.footerRight', 'Footer right'),
        slider('post.t15.footerSize', 'Size', 14, 36, { unit: 'px' }),
        color('post.t15.footerColor', 'Color'),
        slider('post.t15.footerLetterSpacing', 'Spacing', -0.04, 0.2, { step: 0.005, unit: 'em' }),
      ],
    },
    {
      title: 'Watermark',
      fields: [
        image('post.t15.watermarkUrl', 'Logo', [
          toggle('post.t15.showWatermark', 'Show watermark'),
          slider('post.t15.watermarkSize', 'Size', 24, 320, { unit: 'px' }),
          slider('post.t15.watermarkOpacity', 'Opacity', 0, 1, { step: 0.05, unit: '%' }),
          slider('post.t15.watermarkPosX', 'Position X', 0, 120, { unit: '%' }),
          slider('post.t15.watermarkPosY', 'Position Y', 0, 100, { unit: '%' }),
        ]),
      ],
    },
    {
      title: 'Grade & field',
      fields: [
        color('post.t15.overlayColor', 'Overlay'),
        slider('post.t15.overlayOpacity', 'Overlay opacity', 0, 1, { step: 0.02, unit: '%' }),
        slider('post.t15.fadeHeight', 'Top fade', 0, 80, { unit: '%' }),
        slider('post.t15.fadeStrength', 'Top fade strength', 0, 1, { step: 0.02 }),
        toggle('post.t15.showBottomFade', 'Bottom fade'),
        slider('post.t15.bottomFadeHeight', 'Bottom fade', 0, 80, { unit: '%' }),
        slider('post.t15.bottomFadeStrength', 'Bottom fade strength', 0, 1, { step: 0.02 }),
        color('post.t15.fadeColor', 'Fade color'),
        color('post.t15.bgColor', 'Fallback color'),
        toggle('post.t15.showRail', 'Accent rail'),
        slider('post.t15.railWidth', 'Rail width', 4, 28, { unit: 'px' }),
        color('post.t15.railColor', 'Rail color'),
        toggle('post.t15.showPattern', 'Dot grid'),
        slider('post.t15.patternSize', 'Grid size', 12, 48, { unit: 'px' }),
        slider('post.t15.patternOpacity', 'Grid opacity', 0, 0.4, { step: 0.01, unit: '%' }),
        color('post.t15.patternColor', 'Grid color'),
      ],
    },
  ],
  ...
  template16: [
    {
      title: 'Content',
      fields: [
        area('post.t16.headline', 'Headline', { hint: 'Line breaks stay. Use [brackets] for accent words.' }),
        area('post.t16.dek', 'Body', { rows: 3, togglePath: 'post.t16.showDek' }),
        text('post.t16.kickerText', 'Kicker', { togglePath: 'post.t16.showKicker' }),
        text('post.t16.ctaText', 'Button', { togglePath: 'post.t16.showCta' }),
        image('post.t16.logoUrl', 'Logo', [
          toggle('post.t16.showLogo', 'Show logo'),
          slider('post.t16.logoSize', 'Size', 32, 180, { unit: 'px' }),
          slider('post.t16.logoOffsetX', 'Offset X', -80, 80, { unit: 'px' }),
          slider('post.t16.logoOffsetY', 'Offset Y', -40, 40, { unit: 'px' }),
        ]),
        image('post.t16.productUrl', 'Product shot', [
          toggle('post.t16.showProduct', 'Show product'),
          ...imagePos('post.t16.'),
          slider('post.t16.productWidth', 'Width', 50, 100, { unit: '%' }),
          slider('post.t16.productOffsetX', 'Position X', 0, 100, { unit: '%' }),
          slider('post.t16.productHeight', 'Height', 28, 70, { unit: '%' }),
          slider('post.t16.productBottom', 'Bottom inset', 16, 120, { unit: 'px' }),
          slider('post.t16.productRadius', 'Corners', 0, 64, { unit: 'px' }),
          slider('post.t16.productBorder', 'Border', 0, 8, { unit: 'px' }),
          color('post.t16.productBorderColor', 'Border color'),
          toggle('post.t16.showShadow', 'Shadow'),
          slider('post.t16.shadowSize', 'Shadow size', 0, 48, { unit: 'px' }),
          color('post.t16.shadowColor', 'Shadow color'),
        ]),
      ],
    },
    {
      title: 'Typography',
      fields: [
        font('post.t16.fontFamily', 'post.t16.customFontFamily', T2_FONTS),
        slider('post.t16.fontSize', 'Headline size', 36, 120, { unit: 'px' }),
        select('post.t16.fontWeight', 'Weight', FONT_WEIGHTS),
        toggle('post.t16.uppercase', 'Uppercase'),
        color('post.t16.headlineColor', 'Text color'),
        color('post.t16.highlightColor', 'Highlight [ ]'),
        select('post.t16.textAlign', 'Align', ALIGN_OPTIONS),
        select('post.t16.headlinePos', 'Position', HEADLINE_POS_OPTIONS),
        slider('post.t16.stackOffsetX', 'Stack offset X', -80, 80, { unit: 'px' }),
        slider('post.t16.stackOffsetY', 'Stack offset Y', -80, 80, { unit: 'px' }),
        slider('post.t16.lineHeight', 'Line height', 0.9, 1.35, { step: 0.01 }),
        slider('post.t16.letterSpacing', 'Letter spacing', -0.08, 0.06, { step: 0.005, unit: 'em' }),
        slider('post.t16.paddingH', 'Padding X', 32, 120, { unit: 'px' }),
        slider('post.t16.paddingV', 'Padding Y', 32, 120, { unit: 'px' }),
        font('post.t16.dekFontFamily', 'post.t16.customDekFontFamily', T2_FONTS),
        slider('post.t16.dekSize', 'Body size', 16, 42, { unit: 'px' }),
        select('post.t16.dekWeight', 'Body weight', FONT_WEIGHTS),
        color('post.t16.dekColor', 'Body color'),
        slider('post.t16.dekLineHeight', 'Body line height', 1.1, 1.6, { step: 0.01 }),
        slider('post.t16.dekLetterSpacing', 'Body spacing', -0.08, 0.06, { step: 0.005, unit: 'em' }),
        slider('post.t16.kickerSize', 'Kicker size', 12, 28, { unit: 'px' }),
        color('post.t16.kickerColor', 'Kicker color'),
        slider('post.t16.kickerLetterSpacing', 'Kicker spacing', 0, 0.3, { step: 0.01, unit: 'em' }),
      ],
    },
    {
      title: 'Button',
      fields: [
        slider('post.t16.ctaSize', 'Size', 14, 36, { unit: 'px' }),
        select('post.t16.ctaWeight', 'Weight', FONT_WEIGHTS),
        color('post.t16.ctaBg', 'Fill'),
        color('post.t16.ctaColor', 'Text'),
        slider('post.t16.ctaRadius', 'Corners', 0, 40, { unit: 'px' }),
        slider('post.t16.ctaPadH', 'Padding X', 12, 48, { unit: 'px' }),
        slider('post.t16.ctaPadV', 'Padding Y', 8, 28, { unit: 'px' }),
        slider('post.t16.ctaLetterSpacing', 'Spacing', -0.04, 0.08, { step: 0.005, unit: 'em' }),
      ],
    },
    {
      title: 'Field',
      fields: [
        color('post.t16.bgColor', 'Background'),
        select('post.t16.textureId', 'Texture', TEXTURE_OPTIONS),
        slider('post.t16.textureOpacity', 'Texture opacity', 0, 1, { step: 0.02, unit: '%' }),
        slider('post.t16.textureScale', 'Texture scale', 50, 200, { unit: '%' }),
        toggle('post.t16.showBlob', 'Accent blob'),
        color('post.t16.blobColor', 'Blob color'),
        slider('post.t16.blobWidth', 'Blob width', 180, 900, { unit: 'px' }),
        slider('post.t16.blobHeight', 'Blob height', 160, 800, { unit: 'px' }),
        slider('post.t16.blobPosX', 'Blob X', 0, 100, { unit: '%' }),
        slider('post.t16.blobPosY', 'Blob Y', 0, 100, { unit: '%' }),
        slider('post.t16.blobRadius', 'Blob roundness', 20, 50, { unit: '%' }),
        slider('post.t16.blobRotate', 'Blob rotate', -40, 40, { step: 1 }),
      ],
    },
  ],
}
